...
class ItemController extends Controller
{
	...
	public function manage_item()
	{
	  ...
	  return view('manage-item',[ 'itemData' => $itemData, 'encrypter' => $encrypter]);
	}
