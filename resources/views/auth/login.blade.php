                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li class="active">
                                <a href="{{ URL::to('/login') }}">{{ Helper::translation(3225,$translate) }}</a>
                            </li>
                        </ul>
                    </div>
                    <h1 class="page-title">{{ Helper::translation(3225,$translate) }}</h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                     ...
                     @csrf
                        <div class="cardify login">
                            ...
                            <div class="login--form">
                                ...
                                <button class="btn btn--md theme-button" type="submit">{{ Helper::translation(3225,$translate) }}</button>
