            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <?php if($demo_mode == 'on'): ?>
                           ...
                           <?php else: ?>
                       <form action="<?php echo e(route('admin.add-post')); ?>" method="post" enctype="multipart/form-data">
...
<?php /**PATH D:\xampp\htdocs\feberr\resources\views/admin/add-post.blade.php ENDPATH**/ ?>