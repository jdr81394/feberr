                        ...
                        <div class="cardify recover_pass">
                            ...
                            <div class="login--form">
                                <div class="form-group">
                                    ...
                                    <input id="email" type="text" class="text_field <?php if ($errors->has('email')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('email'); ?> is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="email" value="<?php echo e(old('email')); ?>" placeholder="Enter your email address" data-bvalidator="email,required" autocomplete="email" autofocus>
