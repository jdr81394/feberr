                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                       <?php if($demo_mode == 'on'): ?>
                           ...
                           <?php else: ?>
                       <form action="<?php echo e(route('admin.add-vendor')); ?>" method="post" enctype="multipart/form-data">
...
<?php /**PATH D:\xampp\htdocs\feberr\resources\views/admin/add-vendor.blade.php ENDPATH**/ ?>