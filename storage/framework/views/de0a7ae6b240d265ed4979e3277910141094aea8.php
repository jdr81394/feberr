...
<head>
    <title><?php echo e(__('Top Authors')); ?> - <?php echo e($allsettings->site_title); ?></title>
                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li class="active">
                                <a href="<?php echo e(URL::to('/top-authors')); ?>">Top Authors</a>
                            </li>
                        </ul>
                    </div>
                    <h1 class="page-title">Top Authors</h1>
                </div>
                <!-- end /.col-md-12 -->
            </div>
            <!-- end /.row -->
                                    ...
                                    <li class="li-item">
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <div class="user__meta own-next">
                                                ...
                                                <p><?php echo e(__('Member since')); ?> <?php echo e(date("F Y", strtotime($user->created_at))); ?></p>
                                            ...
                                            <div class="user__status user--following text-center last-next">
                                                <p><span class="sale-count"><?php echo e($count_sale->has($user->id) ? count($count_sale[$user->id]) : 0); ?></span><br/>Sales</p>
                                                <?php
...
</html><?php /**PATH D:\xampp\htdocs\feberr\resources\views/top-authors.blade.php ENDPATH**/ ?>