...
if (isset($messageCache)) { $message = $messageCache; }
                                ...
                                <div class="form-group row">
                                   <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                      <label for="email_ad">User Type <span class="required">*</span></label>
                                       <select id="user_type" class="text_field" name="user_type" data-bvalidator="required">
                                          <option value=""></option>
                                          <option value="<?php echo e($encrypter->encrypt('customer')); ?>">Customer</option>
                                          <option value="<?php echo e($encrypter->encrypt('vendor')); ?>">Vendor</option>
                                       </select>
                                    </div>
                                </div>
