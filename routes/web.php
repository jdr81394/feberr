...
Route::get('/upload-item', 'ItemController@upload_item');
...
Route::group(['middleware' => ['is_admin', 'XSS']], function () {
	...
	Route::get('/admin/upload-item', 'Admin\ItemController@upload_item')->name('admin.upload-item');
	Route::post('/admin/upload-item', 'Admin\ItemController@save_items');
